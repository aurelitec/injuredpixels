...
export function ColorSwatches({ selectedIndex, onSelect }: ColorSwatchesProps) {
  return (
    <div className="grid grid-cols-4 gap-2 p-3 rounded-t-panel bg-panel-swatch select-none justify-items-center sm:gap-swatch-gap sm:p-panel-padding lg:grid-cols-8 lg:landscape:grid-cols-8">
